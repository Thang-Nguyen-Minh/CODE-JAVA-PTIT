...
public class LKNXHTN {
    private String ma;
    private long nhap;
    private long gia,xuat,tien,thue;
    public LKNXHTN(String ma,long nhap) {
        this.ma = ma;
        this.nhap = nhap;
    ...
    public String getMa(){
        return String.valueOf(ma.charAt(0)).toUpperCase();
    }
    ...
    public static void main(String[] args){
        ...
        int t=sc.nextInt();
        sc.nextLine();
        ArrayList<LKNXHTN> a=new ArrayList<>();
        while(t-->0){
            LKNXHTN b=new LKNXHTN(sc.nextLine(),sc.nextLong());
            sc.nextLine();
            a.add(b);
        }
        Collections.sort(a,new Comparator<LKNXHTN>() {
            public int compare(LKNXHTN o1,LKNXHTN o2){
                return Long.compare(o2.getThue(),o1.getThue());
            }
        });
        String n=sc.next();
        for(LKNXHTN x:a){
